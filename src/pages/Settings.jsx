        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Input id="siteName" defaultValue="Beijing Mingde Zhixin Consulting Co. Ltd." />
            </div>
            <div className="space-y-2">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="emailFooter" defaultValue="© 2025 Beijing Mingde Zhixin Consulting Co. Ltd. All rights reserved." />
            </div>
