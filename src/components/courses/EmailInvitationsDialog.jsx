...
export const EmailInvitationsDialog = ({ open, onOpenChange, courseId }) => {
  const [organization, setOrganization] = useState('Beijing Mingde Zhixin Consulting Co. Ltd.');
          ...
          <div className="space-y-4">
            <div>
              ...
              <Select value={organization} onValueChange={setOrganization}>
                ...
                <SelectContent>
                  <SelectItem value="Beijing Mingde Zhixin Consulting Co. Ltd.">Beijing Mingde Zhixin Consulting Co. Ltd.</SelectItem>
