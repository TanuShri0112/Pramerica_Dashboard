...
export function WelcomeSection() {
  ...
  const slides = [
    {
      key: "welcome",
      title: "Welcome to Department of Education!",
      subtitle: "We're glad to see you here.",
      body: "Check out the next slides for some useful tips on how to get started with your training and professional development journey.",
      onClick: () => {},
    },
    {
      key: "update-profile",
